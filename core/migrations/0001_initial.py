# Generated by Django 5.2.6 on 2025-10-04 15:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_lead_time', models.DurationField(default=datetime.timedelta(days=1))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('Email', 'Email'), ('SMS', 'SMS'), ('In-App', 'In-App')], max_length=20)),
